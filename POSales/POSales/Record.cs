...
namespace POSales
{
    public partial class Record : Form
    {
        ...
        public void LoadStockInHist()
        {
            ...
            {
                i++;
                dgvStockIn.Rows.Add(i, dr[0].ToString(), dr[1].ToString(), dr[2].ToString(), dr[3].ToString(), dr[4].ToString(), FormatDateTime(dr[5]), dr[6].ToString(), dr[7].ToString(), dr[8].ToString());
            }
            dr.Close();
            cn.Close();
        }
